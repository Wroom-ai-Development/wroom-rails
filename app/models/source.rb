...
class Source < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[author created_at document_id file_size fileless folder_id id name section_headers
       source_url text_category title truncated updated_at user_id year_published]
  end
